#include "../headers/jBlock.hpp"
#include <iostream>

//PRIVATE
void JBlock::createShape(sf::Color color){
    for (int i=0; i<4; i++){
    ...
    vector_square[0].setPosition(sf::Vector2f((NUMBER_SQUARE_LENGTH/2) * SIZE_SQUARE - SIZE_SQUARE , 2*SIZE_SQUARE));
    vector_square[1].setPosition(sf::Vector2f((NUMBER_SQUARE_LENGTH/2) * SIZE_SQUARE , 2*SIZE_SQUARE));
    vector_square[2].setPosition(sf::Vector2f((NUMBER_SQUARE_LENGTH/2) * SIZE_SQUARE, SIZE_SQUARE));
    vector_square[3].setPosition(sf::Vector2f((NUMBER_SQUARE_LENGTH/2) * SIZE_SQUARE , 0));
}
...
void JBlock::turn(std::vector<std::vector<int>> completed_square){
